...
function endGame() {
    ...
    // Entfernen der Frage und Antwortmöglichkeiten
    ...
    // Eventlistener für den "Spiel beenden"-Button
    endButton.onclick = () => {
        window.location.href = "main.html"; // Nur hier wird die Seite gewechselt
    };
}
